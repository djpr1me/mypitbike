...
A. Dust cover B. Adjuster C. Locknut
...
A. Throttle Grip B. 2-3mm (0.08-0.12 in)
...
A. D: 5mm (0.2 in) C. Chain Guard B. Hollow D. Push Up
...
If the ins**Chain Slack Adjustment**
...
## 47 Front Brake Pad Replacement
...
A. Handlebar Clamp Bolts B. Handlebar Loosen the steering stem head nut and front fork upper clamp bolts.

![Image3](../../../static/img/335808cf2b335a185304f47f7162a3fa8496d6ac961d7f7aef65d48439557f20.jpg)

A. Stem Head Nut B. Front Fork Upper Clamp Bolts Turn the steering stem locknut with the stem nut wrench (special tool) to obtain the proper adjustment.
...
A. Stem Locknut B. Stem Nu# T Wrench (P/N.57001-1100)
