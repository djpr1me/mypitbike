...
Thank you for purchasing an ANIMA 190F Engine. This manual explains the operation, inspection, basic maintenance, and tuning of the engine. If you have any questions, please contact the dealer you purchased the engine/bike from. Please read this manual very carefully before use.

1. ANIMA 190F ENGINE is designed strictly FOR COMPETITION USE, ONLY ON A CLOSED COURSE. It is illegal to use this engine on any public road or highway. Off-road use in public space is also illegal. Please check local regulations before use.
...
If Products require servicing, you must take them to an authorized dealer appointed by authorized local distributors of DAYTONA. DAYTONA Corp. JAPAN is NOT in the position to handle services of any kind with the customers or authorized dealers due to contracts with authorized local distributors.
...
| Displacement (ANIMA 190F)            | 187.18 cm³           |
| Bore × stroke (ANIMA 190F)           | 62.0 × 62.0 mm (2.441 x 2.441 in) |
...
| Slow Jet         | #42                                           |
| Throttle Valve   | #6.0                                          |
| Jet Needle       | #86590 W956R-1175W (DAYTONA original)/#86640 W956R-1171N  |
|                  | Clip position: In the 2nd or 3rd groove from the top |
| Air Screw        | 2 return                                      |
...
ANIMA 190F ENGINE comes with an ignition timing selectable CDI unit.
...
ANIMA 190F ENGINE comes with a rev limiter selectable CDI unit.
